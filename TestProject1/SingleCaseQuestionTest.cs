...
namespace TestProject1
{
    ...
    public class SingleCaseQuestionTest
    {
        ...
        public void SingleCaseQuestionAdd()
        {
            ...
            singleCaseQuestion.Answers.Add(singleCaseAnswer1);
            singleCaseQuestion.Answers.Add(singleCaseAnswer2);
            ...
            Assert.True(((SingleCaseAnswer)personRepository.GetAsync(testid).Result.Questions[0].Answers[1]).TrueVarriant);
            Assert.Equal("ответ 1", personRepository.GetAsync(testid).Result.Questions[0].Answers[0].Content);
        }
    }
}